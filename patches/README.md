...
**36 patches** applied in numeric order on a stock `git checkout v0.5.12`. Source of truth for **what's fixed and how**; main [README.md](../README.md) tracks current state.
...
|-----------|---------|--------|
| SGLang | v0.5.12 | stock + 36 patches (rebased from v0.5.11 — see header) |
