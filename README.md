...
- **Vision support** — Devstral-24B, Qwen3.5-27B, Gemma 4 31B: vision WORKING. Gemma 4 26B MoE: text fixed (torch_native attn), vision DEGRADED — BF16 vision weights restored but quantized text decoder misaligned (answers "Blue" for red/green). Needs vision-language calibration data in GPTQ pipeline.
