...
| Gemma 4 31B | Dense (Gemma4) | 256K / ~51K | 15 / 11.6 | `launch.sh gemma4-31b` | Working (torch_native; basic+thinking PASS). Native FP8 (17.57 GB/card, no Linear fallback); FP8 cap is memory (SWA dense). Vision = known AWQ HSAIL (not FP8). |
