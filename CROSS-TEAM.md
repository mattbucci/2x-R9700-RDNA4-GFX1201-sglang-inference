...
**Update (2026-09-22 22:05):** host rebooted with `amdgpu.runpm=0` + `ptrace_scope=0` + a 3-min
reboot watchdog; a boot-time one-shot unit relaunches the same v4 chain at [153/300].
