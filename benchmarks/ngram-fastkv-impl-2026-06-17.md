...
- [ ] integrate behind `SGLANG_TREE_VERIFY_SPLITKV` in triton_backend `is_target_verify`  [ ] in-server lossless (temp=0 NGRAM==no-spec)  [ ] depth bench (verify ms @244K should drop ~16×)
